...
const ShopPage = () => {
  ...
  const brands = [
    ...
    },
    {
      ...
      description:
        'Muha Meds предлагает широкий ассортимент высокопотентных картриджей с разнообразными сортами для любого настроения и времени суток.',
      ...
      strains: [
        ...
        },
        {
          ...
          cbd: '0.5%',
          description:
            'Поднимает настроение, даёт лёгкое, ясное и при этом уверенное состояние.',
        ...
        },
        {
          ...
          cbd: '0.3%',
          description:
            'Мощный прилив энергии, активное, немного хаотичное воодушевление.',
        ...
        },
        {
          ...
          cbd: '1.2%',
          description: `
    Глубокое расслабление с лёгкой сладостью на фоне.
    Помогает отключиться от суеты, снять напряжение и насладиться моментом.
    Идеально подходит для позднего вечера, восстановления после долгого дня или приятного сна.
          `.trim(),
        ...
        },
        {
          ...
          cbd: '0.7%',
          description:
            'Мягкое и медитативное состояние. Не валит, а как бы растворяет в спокойствии.',
        ...
        },
        {
          ...
          cbd: '0.9%',
          description: `
    Тяжёлый, густой эффект, типичный для топовых OG.
    Расслабляет тело, притупляет мысли и помогает отключиться от повседневной суеты.
    Идеально для вечеров без планов и лишних разговоров.
          `.trim(),
        ...
        },
        {
          ...
          cbd: '0.6%',
          description: `
    Изысканный баланс бодрости и лёгкой эйфории.
    Дарит ясность ума, лёгкое настроение и помогает почувствовать вкус к жизни.
    Идеален для дневного отдыха, прогулок или креативных занятий.
    Мягкий заряд энергии без излишней суеты.
          `.trim(),
        ...
        },
        {
          ...
          cbd: '0.7%',
          description: `
    Тёплая тяжесть и глубокое расслабление с лёгким сладким послевкусием.
    Снимает тревожность, помогает отпустить лишние мысли и погружает в состояние комфортного покоя.
    Идеальный выбор для отдыха после напряжённого дня или медленного вечера в тишине.
          `.trim(),
        ...
        },
        {
          ...
          cbd: '0.5%',
          description:
            'Чёткий гибрид: лёгкое приподнятое настроение, спокойствие без сонливости.',
